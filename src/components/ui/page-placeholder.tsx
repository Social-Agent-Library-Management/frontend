 ...
 * 흰 표면 컨테이너는 `Card`를 재사용한다(직접 만들지 말 것).
 */
export function PagePlaceholder({
  ...
  return (
    <div className={cn("px-page-x py-page-y", className)} {...props}>
      <h1 className="mb-6 text-3xl leading-tight font-bold tracking-tight text-fg">
        {title}
      </h1>
      <Card padding="lg">
